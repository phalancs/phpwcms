...
require(PHPWCMS_ROOT.'/include/lib/dbcon.inc.php');
require(PHPWCMS_ROOT.'/include/lib/general.inc.php');
require(PHPWCMS_ROOT.'/include/lib/backend.functions.inc.php');
...
switch($method) {
	...
	default:	header('Content-type: application/json');
				if(!function_exists('json_encode')) {
					...
					require(PHPWCMS_ROOT.'/include/ext/JSON/JSON.php');
