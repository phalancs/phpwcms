...
define('PHPWCMS_JSLIB', 'jquery-1.4');

/**
 * Init jQuery 1.4.x Library
 */
function initJSLib() {
	if(empty($GLOBALS['block']['custom_htmlhead']['jquery.js'])) {
		if(!USE_GOOGLE_AJAX_LIB) {
			...
			$GLOBALS['block']['custom_htmlhead']['jquery.js'] = getJavaScriptSourceLink(USE_GOOGLE_AJAX_LIB.'jquery/1.4/jquery.min.js');
		}
	}
	return TRUE;
}
