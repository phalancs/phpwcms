...
<div class="navBarLeft imgButton chatlist">
	&nbsp;&nbsp;
	<a href="<?php echo MODULE_HREF ?>&amp;campaign=1&amp;edit=0" title="<?php echo $BLM['create_new'] ?>"><img src="include/img/famfamfam/transmit_add.gif" alt="New" border="0" /><span><?php echo $BLM['create_new'] ?></span></a>
	&nbsp;
	<a href="<?php echo MODULE_HREF ?>&amp;adplace=1&amp;edit=0" title="<?php echo $BLM['new_adplace']	 ?>"><img src="include/img/famfamfam/layout_add.gif" alt="New" border="0" /><span><?php echo $BLM['new_adplace'] ?></span></a>
</div>
