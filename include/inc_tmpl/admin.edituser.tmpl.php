...
?><form action="phpwcms.php?do=admin&amp;s=2&amp;u=<?php echo $new_user_id ?>" method="post" name="edituser"><table border="0" cellpadding="0" cellspacing="0" summary="">
          ...
          <tr> 
            ...
            <td><img src="include/img/leer.gif" alt="" width="1" height="7"></td>
          </tr>
		  <?php
		  if(!empty($user_err)) {
		  ?>
          ...
          <tr><td colspan="2"><img src="include/img/leer.gif" alt="" width="1" height="6"><input name="form_aktion" type="hidden" value="edit_account"><input name="form_uid" type="hidden" value="<?php echo $new_user_id ?>"></td></tr>
          <tr> 
            <td>&nbsp;</td>
