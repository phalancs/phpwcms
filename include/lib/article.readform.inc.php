...
if($content["type"] != 30 && file_exists(PHPWCMS_ROOT."/include/lib/content/cnt".$content["type"].".readform.inc.php")) {
	$content["module"]	= '';
	include_once(PHPWCMS_ROOT."/include/lib/content/cnt".$content["type"].".readform.inc.php");
	...
	$content["module"]	= '';
	include_once(PHPWCMS_ROOT."/include/lib/content/cnt0.readform.inc.php");
