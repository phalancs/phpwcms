...
$content["search"]["label_input"] = html(clean_slweg($_POST["csearch_label_input"]));
$content["search"]["style_input"] = html(clean_slweg($_POST["csearch_style_input"]));
$content["search"]["label_button"] = html(clean_slweg($_POST["csearch_label_button"]));
$content["search"]["style_button"] = html(clean_slweg($_POST["csearch_style_button"]));
$content["search"]["label_result"] = slweg($_POST["csearch_label_result"]);
$content["search"]["style_result"] = html(clean_slweg($_POST["csearch_style_result"]));
