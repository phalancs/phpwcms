...
if($file_result = mysql_query($file_sql, $db) or die ("error while listing files")) {
	...
	while($file_row = mysql_fetch_array($file_result)) {
		...
		echo "<tr>\n";
		echo "<td width=\"19\" class=\"msglist\"><img src=\"include/img/leer.gif\" height=\"1\" width=\"19\" border=\"0\"></td>\n";
		...
		echo " /></td>\n";
		echo "<td width=\"406\" class=\"msglist\"><img src=\"include/img/leer.gif\" height=\"1\" width=\"5\" />";
		...
		if($cutID == $file_row["f_id"]) {
			echo "<img src=\"include/img/button/cut_13x13_1.gif\" border=\"0\" title=\"".$BL['be_fprivfunc_clipfile'].": ".$filename."\">";
		} else {
			echo "<a href=\"".$zieldatei."&cut=".$file_row["f_id"]."\" title=\"".$BL['be_fprivfunc_cutfile'].": ".$filename."\">";
			echo "<img src=\"include/img/button/cut_13x13_0.gif\" border=\"0\"></a>";
		}
		...
		if($_SESSION["wcs_user_thumb"]) {
			...
			if($thumb_image != false) {
				...
				echo "<tr>\n";
				echo "<td width=\"19\"><img src=\"include/img/leer.gif\" height=\"1\" width=\"1\" border=\"0\"></td>\n";
				echo "<td width=\"13\"><img src=\"include/img/leer.gif\" height=\"1\" width=\"1\" border=\"0\"></td>\n<td width=\"";
				echo "406\"><img src=\"include/img/leer.gif\" height=\"1\" width=\"6\"><a href=\"fileinfo.php?fid=";
				...
				echo "<td width=\"100\"><img src=\"include/img/leer.gif\" height=\"1\" width=\"1\" border=\"0\"></td>\n</tr>\n";
