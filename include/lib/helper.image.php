...
class Phpwcms_Image_lib {
	...
	function image_process_imagemagick($action = 'resize')
	{
		...
		if($this->sharpen)
		{
			...
			switch($this->sharpen)
			{
				case 1: $cmd .= ' -sharpen 1x10'; break;
				case 2:	$cmd .= ' -sharpen 3x10'; break;
				case 3:	$cmd .= ' -sharpen 5x10'; break;
				case 4:	$cmd .= ' -sharpen 7x10'; break;
				case 5: $cmd .= ' -sharpen 9x10'; break;
			}
		}
	...
	{	
		if(!$this->lang_localized) {
			...
			if($local_lang && is_file(PHPWCMS_ROOT.'/include/lang/image/image.'.$local_lang.'.php')) {
				include(PHPWCMS_ROOT.'/include/lang/image/image.'.$local_lang.'.php');
