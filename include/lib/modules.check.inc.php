...
$phpwcms_modules	= returnSubdirListAsArray(PHPWCMS_ROOT.'/include/modules');
$value				= '';
...
foreach($phpwcms_modules as $value) {
	...
	if(is_file(PHPWCMS_ROOT.'/include/modules/'.$value.'/module.default.php')) {
	
		// main settings
		require(PHPWCMS_ROOT.'/include/modules/'.$value.'/module.default.php');
		...
		if($_module_name !== '') {
			...
			$phpwcms['modules'][$_module_name]['path']		= PHPWCMS_ROOT.'/include/modules/'.$value.'/';
			$phpwcms['modules'][$_module_name]['dir']		= 'include/modules/'.$value.'/';
			...
			if($_module_fe_render && is_file(PHPWCMS_ROOT.'/include/modules/'.$value.'/frontend.render.php')) {
				$phpwcms['modules_fe_render'][]	= PHPWCMS_ROOT.'/include/modules/'.$value.'/frontend.render.php';
			}
			if($_module_fe_init && is_file(PHPWCMS_ROOT.'/include/modules/'.$value.'/frontend.init.php')) {
				$phpwcms['modules_fe_init'][]	= PHPWCMS_ROOT.'/include/modules/'.$value.'/frontend.init.php';
			}
