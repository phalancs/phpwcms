...
if($wysiwyg_editor['editor'] == 2) {
	...
	//load FCKeditor
	include_once(PHPWCMS_ROOT.'/include/ext/fckeditor/fckeditor.php');

	$oFCKeditor = new FCKeditor($wysiwyg_editor['field']);
	$oFCKeditor->BasePath 							= PHPWCMS_URL.'include/ext/fckeditor/';
	$oFCKeditor->Config['CustomConfigurationsPath']	= PHPWCMS_URL.'include/ext/fckeditor/fckeditor_config.js.php' ;
	...
	$BE['HEADER']['ckeditor.js']	= getJavaScriptSourceLink('include/ext/ckeditor/ckeditor.js');
