...
<div class="navBarLeft imgButton chatlist">
	&nbsp;&nbsp;
	<a href="<?php echo shop_url(array('controller=prod', 'edit=0')) ?>" title="<?php echo $BLM['create_new_prod'] ?>"><img src="include/img/famfamfam/package_add.gif" alt="Add" border="0" /><span><?php echo $BLM['create_new_prod'] ?></span></a>
</div>
...
foreach($data as $row) {
	...
	echo '<img src="include/img/famfamfam/package.gif" alt="'.$BLM['shop_product'].'" /></td>'.LF;
