...
?>	
	...
	if($result = mysql_query($sql, $db)) {
		while($userlist = mysql_fetch_assoc($result)) {
...
?>
	...
	echo $userlist["usr_name"];
          ...
          <td width="61" align="right"><a href="include/actions/user.php?aktiv=<?php 
			...
			?>aktiv_mini.gif" alt="" width="14" height="15" border="0"></a><a href="<?php echo $goto ?>"><img src="include/img/button/edit.gif" alt="" width="24" height="15" border="0" title="<?php echo $BL['be_admin_usr_editusr'].": ".html($userlist["usr_login"]) ?>"></a><a href="include/actions/user.php?del=<?php 
		  echo urlencode($userlist["usr_id"].":".$userlist["usr_email"]);
		  ?>" onclick="return confirm('Delete user <?php echo js_singlequote($userlist["usr_name"]) ?>');"><img src="include/img/button/del_message_final.gif" alt="" width="22" height="15" border="0" title="<?php echo $BL['be_admin_usr_ldel']." ".html($userlist["usr_login"]) ?>"></a></td>
        </tr>
        <?php
				$zaehler++;
			}
