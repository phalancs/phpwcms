...
<?php
	...
	if($content['type'] != 30 && file_exists(PHPWCMS_ROOT.'/include/tmpl/content/cnt'.$content['type'].'.inc.php')) {
	
		include_once(PHPWCMS_ROOT.'/include/tmpl/content/cnt'.$content['type'].'.inc.php');
		...
		include_once(PHPWCMS_ROOT.'/include/tmpl/content/cnt0.inc.php');
