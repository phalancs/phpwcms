...
<?php
	...
	if($row['acontent_type'] != 30 && file_exists('include/tmpl/content/cnt'.$row['acontent_type'].'.list.inc.php')) {
	
		include(PHPWCMS_ROOT.'/include/tmpl/content/cnt'.$row['acontent_type'].'.list.inc.php');
		...
		// default fallback
		include(PHPWCMS_ROOT.'/include/tmpl/content/cnt0.list.inc.php');
