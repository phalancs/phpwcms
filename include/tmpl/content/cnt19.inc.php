...
?>
<tr>
  <td align="right" class="chatlist" valign="top"><img src="include/img/leer.gif" alt="" width="1" height="15"><?php echo $BL['be_cnt_guestbook_before'] ?>:&nbsp;</td>
...
<tr>
  <td align="right" class="chatlist" valign="top"><img src="include/img/leer.gif" alt="" width="1" height="15"><?php echo $BL['be_cnt_guestbook_after'] ?>:&nbsp;</td>
