...
if(!empty($_SESSION["WYSIWYG_EDITOR"]) && !$content['tabwysiwygoff']) {
	...
	$BE['HEADER']['fckeditor.js']	= '	<script type="text/javascript" src="include/ext/fckeditor/fckeditor.js"></script>';
...
?>
			...
			<table cellpadding="0" cellspacing="0" border="0" summary="">
				...
				<tr>
					<td colspan="3" class="tdtop5"><textarea name="tabtext[<?php echo $key ?>]" id="tabtext<?php echo $key ?>" rows="10" class="v12" style="width:536px;height:150px;"><?php echo html($value['tabtext']) ?></textarea></td>
				</tr>
...
<tr>
	...
	var fckbase	= '<?php echo PHPWCMS_URL.'include/ext/fckeditor/'; ?>';
