...
<tr>
	...
	<td><table cellpadding="0" cellspacing="0" border="0" summary="">
		<tr>
			<td><input type="text" name="news_category" id="news_category" value="<?php echo html(implode(', ', $content['news']['news_category'])) ?>" class="width350 bold" /></td>
			<td>&nbsp;</td>
...
<tr>
	...
	<td><input type="text" name="news_lang" id="news_lang" value="<?php echo html(implode(', ', $content['news']['news_lang'])) ?>" class="width200" /></td>
</tr>
