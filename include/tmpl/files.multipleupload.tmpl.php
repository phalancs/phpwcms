...
<form action="<?php echo PHPWCMS_URL?>include/actions/ajax_uploader.php?<?php echo session_name().'='.session_id(); ?>" method="post" enctype="multipart/form-data" id="upload-form">
