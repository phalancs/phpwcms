...
if(isset($_GET["s"]) && isset($_GET["edit"])) {
	...
	if(isset($_POST['subscribe_email'])) {
		include_once(PHPWCMS_ROOT.'/include/lib/subscriber.form.inc.php');
	}
	
	if($_userInfo['subscriber_data']) {
		include_once(PHPWCMS_ROOT.'/include/tmpl/subscriber.form.tmpl.php');
	}
}
...
if(isset($_GET['import']) && $_GET['import'] === '1') {
	...
	if(isset($_POST['delimeter'])) {
		...
		include_once(PHPWCMS_ROOT.'/include/lib/subscriberimport.form.inc.php');
		
		if(isset($_userInfo['csvError'])) {
			include_once(PHPWCMS_ROOT.'/include/tmpl/subscriberimport.form.tmpl.php');
		} else {
			include_once(PHPWCMS_ROOT.'/include/tmpl/subscriberimport.result.tmpl.php');
		}
