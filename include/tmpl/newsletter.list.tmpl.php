...
if(isset($_GET["s"])) {
	...
	include_once(PHPWCMS_ROOT.'/include/lib/newsletter.form.inc.php');
	
	if(isset($_GET['edit'])) {
		include_once(PHPWCMS_ROOT.'/include/tmpl/newsletter.form.tmpl.php');
	}

	if(isset($_GET['send']) && $show_nl_send) {

		include_once(PHPWCMS_ROOT.'/include/tmpl/newsletter.send.tmpl.php');
