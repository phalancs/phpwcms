...
include_once PHPWCMS_ROOT."/include/lang/code.lang.inc.php";
$lang_dirs = opendir(PHPWCMS_ROOT."/include/lang/backend");
while($lang_codes = readdir( $lang_dirs )) {
	if( $lang_codes != "." && $lang_codes != ".." && file_exists(PHPWCMS_ROOT."/include/lang/backend/".$lang_codes."/lang.inc.php")) {
...
?>
	...
	<tr> 
		...
		<td><select name="form_wysiwyg" id="form_wysiwyg" class="v12 width250" style="margin-bottom:2px;" onchange="setWYSIWYGtemplate();">
				...
				<option value="1"<?php is_selected(1, $_SESSION["WYSIWYG_EDITOR"]) ?>>CKEditor 3.5</option>
