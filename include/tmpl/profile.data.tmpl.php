...
<?php
	...
	if(!empty($detail_updated)) {
		echo '<tr><td colspan="3" class="error"><img src="include/img/leer.gif" alt=" width="1" height="10" /><br /><strong>';
		echo nl2br(chop($detail_updated)).'</strong></td></tr>';
	}
?>
	<tr> 
		<td width="110" height="12"><img src="include/img/leer.gif" alt="" width="110" height="10"></td>
		<td><img src="include/img/leer.gif" alt="" width="25" height="1"></td>
        <td><img src="include/img/leer.gif" alt="" width="403" height="1"></td>
	</tr>
	<tr> 
	...
	<tr><td colspan="3"><img src="include/img/leer.gif" alt="" width="1" height="7"></td></tr>
	<tr> 
		<td align="right" valign="top"><img src="include/img/leer.gif" alt="" width="1" height="13"><?php echo $BL['be_profile_label_signature'] ?>:&nbsp;</td>
	...
	<tr><td colspan="3"><img src="include/img/leer.gif" alt="" width="1" height="2"></td></tr>
	<tr> 
		<td align="right" valign="top"><img src="include/img/leer.gif" alt="" width="1" height="13"><?php echo $BL['be_profile_label_notes'] ?>:&nbsp;</td>
	...
	<tr><td colspan="3"><img src="include/img/leer.gif" alt="" width="1" height="15"><input name="form_aktion" type="hidden" id="form_aktion" value="<?php echo $form_detail_aktion ?>"></td></tr>
	<tr> 
		<td align="right">&nbsp;</td>
		<td colspan="2"><input type="submit" name="Submit" value="<?php echo $BL['be_profile_label_button'] ?>" class="button10"></td>
	</tr>
	<tr><td colspan="3"><img src="include/img/leer.gif" alt="" width="1" height="20"></td></tr>
</table></form>
