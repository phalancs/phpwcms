...
<ol>
  ...
  <li>PHP version: <?php 
	...
	switch(version_compare('5.1.0', phpversion())) {
		...
		case -1:	// current used PHP is > OK
					echo '<img src="../include/img/famfamfam/icon_accept.gif" alt="OK" class="icon1" />';
		...
		case  0:	// the same version - HM not recommend
					echo '<img src="../include/img/famfamfam/icon_alert.gif" alt="OK" class="icon1" />';
					echo ' (your version of PHP is older - update recommend)';
					break;
				
		case  1:	// false it's older
					echo '<img src="../include/img/famfamfam/action_stop.gif" alt="Stop" class="icon1" />';
  ...
  ?></li>
  <li>PHP settings<a href="http://www.php.net/manual/security.php" target="_blank" title="PHP Security"><img src="../include/img/famfamfam/icon_info.gif" alt="Security risks" class="icon1" border="0" /></a>
  	<ul>
      <li><strong>register_globals </strong><?php
		  ...
		  if(ini_get('register_globals')) {
			...
			echo '<img src="../include/img/famfamfam/icon_info.gif" alt="Security risks" class="icon1" border="0" />';
			echo '</a>)';
		  } else {
      ...
      <li><strong>safe_mode </strong><?php
		  ...
		  if(ini_get('safe_mode')) {
		    ...
		    echo '<strong>Off</strong>';
			echo '<img src="../include/img/famfamfam/icon_alert.gif" alt="Warning" class="icon1" />';
  	  ...
  	  <li><?php
				...
				if(function_exists('imagegd2')) {
					...
					echo '<img src="../include/img/famfamfam/icon_accept.gif" alt="GD2" class="icon1" />';
					$is_gd = true;
				} elseif(function_exists('imagegd')) {
					echo '1</strong> '.$_phpinfo['gd_version'];
					echo '<img src="../include/img/famfamfam/icon_alert.gif" alt="GD1" class="icon1" />';
					echo ' (GD2 is recommend)';
					$is_gd = true;
				} else {
					echo ' not available</strong>';
					echo '<img src="../include/img/famfamfam/action_stop.gif" alt="GD not present" class="icon1" />';
					$is_gd = false;
				}
				...
				if($is_gd) {
					...
					if(imagetypes() & IMG_GIF) {
						$is_gd[] = 'GIF<img src="../include/img/famfamfam/icon_accept.gif" alt="GIF supported" class="icon1" />';
					} else {
						$is_gd[] = 'GIF<img src="../include/img/famfamfam/action_stop.gif" alt="GIF not supported" class="icon1" />';
					}
					if(imagetypes() & IMG_PNG) {
						$is_gd[] = 'PNG<img src="../include/img/famfamfam/icon_accept.gif" alt="PNG supported" class="icon1" />';
					} else {
						$is_gd[] = 'PNG<img src="../include/img/famfamfam/action_stop.gif" alt="PNG not supported" class="icon1" />';
					}
					if(imagetypes() & IMG_JPG) {
						$is_gd[] = 'JPG<img src="../include/img/famfamfam/icon_accept.gif" alt="JPG supported" class="icon1" />';
					} else {
						$is_gd[] = 'JPG<img src="../include/img/famfamfam/action_stop.gif" alt="JPG not supported" class="icon1" />';
					}
