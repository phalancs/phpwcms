...
<form action="setup.php?step=2" method="post">
  <table border="0" cellpadding="0" cellspacing="0" summary="">
          <tr>
            ...
            <td><input name="site" type="text" class="f11b" id="site" value="<?php echo html($phpwcms["site"]) ?>" size="30" style="width:200px"></td>
          ...
          <tr>
            <td colspan="3"><img src="../include/img/leer.gif" alt="" width="1" height="25"></td>
          </tr>
          <tr>
		  ...
		  <tr>
            ...
            <td><input name="smtp_from_email" type="text" class="f11b" id="smtp_from_email" value="<?php echo ($phpwcms['SMTP_FROM_EMAIL']) ? html($phpwcms['SMTP_FROM_EMAIL']) : html($phpwcms["admin_email"]) ?>" size="30" style="width:200px"></td>
            <td class="chatlist"><em>&nbsp;default: <?php echo html($phpwcms["admin_email"]) ?></em></td>
    </tr>
		  <tr>
		  ...
		  <tr>
            ...
            <td><input name="smtp_from_name" type="text" class="f11b" id="smtp_from_name" style="width:200px" value="<?php echo ($phpwcms['SMTP_FROM_NAME']) ? html($phpwcms['SMTP_FROM_NAME']) : 'webmaster' ?>" size="30"></td>
		  ...
		  <tr>
            ...
            <td><input name="smtp_host" type="text" class="f11b" id="smtp_host" value="<?php echo ($phpwcms['SMTP_HOST']) ? html($phpwcms['SMTP_HOST']) : 'localhost' ?>" size="30" style="width:200px"></td>
		  ...
		  <tr>
            ...
            <td><input name="smtp_user" type="text" class="f11b" id="smtp_user" value="<?php echo html($phpwcms['SMTP_USER']) ?>" size="30" style="width:200px"></td>
            <td class="chatlist">&nbsp;</td>
    </tr>
		  <tr>
		    <td colspan="3"><img src="../include/img/leer.gif" alt="" width="1" height="2"></td>
		  ...
		  <tr>
            ...
            <td><input name="smtp_pass" type="text" class="f11b" id="smtp_pass" style="width:200px" value="<?php echo html($phpwcms['SMTP_PASS']) ?>" size="30"></td>
            <td class="chatlist">&nbsp;</td>
    </tr>
		  <tr>
		    <td colspan="3"><img src="../include/img/leer.gif" alt="" width="1" height="15"></td>
    </tr>
          <tr>
            <td align="right" class="v10">&nbsp;</td>
